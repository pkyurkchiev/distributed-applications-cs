...
namespace MC.Website.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var movieCatalogDbContext = _context.Movies.Include(m => m.Genre);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,GenreId,Rating,Country")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,GenreId,Rating,Country")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
